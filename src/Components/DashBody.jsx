...
const DashBody = (prop) => {
    ...
    const drawChart = (ctx) => {
        ...
        ctx.lineTo(points[points.length - 1].x, chartHeight - padding + 800); // Line down to the x-axis
        ctx.lineTo(points[0].x, chartHeight - padding + 800); // Line back to the starting point on the x-axis
        ctx.closePath();
