                                    ...
                                    <div className="w-full flex gap-7 md:flex-nowrap flex-wrap">
                                        <div className='dark:bg-blue-950 md:w-1/2 w-full rounded-xl pb-3'>
                                            <div className='pt-7 px-7 pb-2'>
                                                ...
                                                <p className='text-gray-500 text-xs mt-1 flex gap-3 items-center'>
                                                    <svg className='w-4' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M7 24h-6v-6h6v6zm8-9h-6v9h6v-9zm8-4h-6v13h6v-13zm0-11l-6 1.221 1.716 1.708-6.85 6.733-3.001-3.002-7.841 7.797 1.41 1.418 6.427-6.39 2.991 2.993 8.28-8.137 1.667 1.66 1.201-6.001z" /></svg>
                                                    {"4% (30 days)"}
                                                </p>
                                            </div>
                                            <LineChart
                                        ...
                                        <div className='dark:bg-blue-950 md:w-1/2 w-full rounded-xl pb-3'>
                                            <div className='pt-7 px-7 pb-2'>
                                                ...
                                                <p className='text-gray-500 text-xs mt-1 flex gap-3 items-center'>
                                                    <svg fill='red' className='w-4' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M7 24h-6v-6h6v6zm8-9h-6v9h6v-9zm8-4h-6v13h6v-13zm-21.976 4.875l6-1.221-1.716-1.708 4.183-4.108 3.001 3.002 10.508-10.422-1.41-1.418-9.094 9.015-2.991-2.993-5.613 5.512-1.667-1.66-1.201 6.001z" /></svg>
                                                    {"4% (30 days)"}
                                                </p>
                                            </div>
                                            <LineChart
