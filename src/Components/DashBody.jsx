...
const DashBody = (prop) => {
    ...
    const drawChart = (ctx) => {
        ...
        // Fill the area under the curve
        ctx.lineTo(points[points.length - 1].x, chartHeight - padding + 250); // Line down to the x-axis
        ctx.lineTo(points[0].x, chartHeight - padding + 250); // Line back to the starting point on the x-axis
        ctx.closePath();
        ctx.fillStyle = 'green';
        ctx.fill();
                        ...
                        <div>
                            ...
                            <div className='w-full mt-5 flex flex-wrap md:flex-nowrap gap-8'>
                                <div className='md:w-1/2 w-full flex flex-wrap md:flex-nowrap gap-8'>
                                    ...
                                    <div className='md:w-1/3 pt-4 rounded-xl w-full bg-[#d7edfd] text-center'>
                                        <p className=''>Limit</p>
