                            ...
                            <div className='w-full mt-5 flex flex-wrap md:flex-nowrap gap-8'>
                                <div className='md:w-1/2 w-full'>
                                    ...
                                    <div className='bg-white dark:bg-blue-950 mt-12 shadow p-6 rounded-lg'>
                                        ...
                                        <div className='mt-2'>
                                            <button className='dark:text-white dark:border items-center px-4 py-2 rounded-xl bg-slate-100 flex dark:bg-[rgba(45,53,81,0.37)] border border-[rgb(36,49,92)]'>
