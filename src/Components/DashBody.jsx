                                ...
                                <div className='md:w-1/2 w-full'>
                                    <div className='w-2/3'>
                                        ...
                                        <div className='flex justify-center'>
                                            <div className='shadow mt-4 bg-white rounded-full w-16 h-16 absolute flex items-center justify-center'>
                                        ...
                                        <div className='w-[80%] bg-white m-auto shadow rounded-b-xl h-8 relative z-10'></div>
