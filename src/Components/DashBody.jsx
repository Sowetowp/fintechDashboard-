                ...
                <section className='max-w-7xl w-full mx-auto'>
                    <div className='w-[22%] py-3'>
                        <div className='overflow-hidden'>
                            ...
                            <div className={`overflow-hidden transition-all duration-1000 ease-out ${drop.dashboard ? 'max-h-[100vh]' : 'max-h-0'} ${drop.dashboard ? "block opacity-100" : "hidden opacity-0"}`}>
