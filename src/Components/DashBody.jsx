                    ...
                    <div className='w-[22%] py-3'>
                        <div className='flex justify-around flex-wrap items-center group'>
                            ...
                            <div className='w-full'>
                                <a className='block text-center text-gray-500' href="">Profile</a>
                                <a className='block text-center text-gray-500' href="">Email</a>
                                <a className='block text-center text-gray-500' href="">Calendar</a>
                                <a className='block text-center text-gray-500' href="">Shop</a>
                            </div>
                        </div>
                    </div>
                </section>
