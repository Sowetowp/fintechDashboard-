                ...
                <section className='max-w-7xl w-full mx-auto'>
                    <div className='w-[22%] py-3'>
                        ...
                        <div key={index} className='py-3'>
                            <a className='flex cursor-pointer justify-between px-8 flex-wrap items-center group' onClick={() => dispatch({ type: drop.dashboard ? "close" : "open", val: "dashboard" })}>
                            ...
                            <div ref={contentRef} className={`overflow-hidden transition-all duration-1000 ease`} style={{ maxHeight: drop.dashboard ? height : "0px" }}>
