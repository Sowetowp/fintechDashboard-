                                    ...
                                    <div className='dark:bg-blue-950 shadow mt-7 p-7 w-full rounded-xl'>
                                        ...
                                        <div>
                                            <div className='w-1/2 rounded-xl bg-purple-500 p-4'>
                                                <div className='rounded-full w-24 h-24 m-auto bg-[rgba(243,232,255,0.27)]'>
                                                    <div className='rounded-tl-full-full w-1/2 h-24 bg-white'></div>
                                                    <div className='rounded-full w-1/2 h-24 bg-white'></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
