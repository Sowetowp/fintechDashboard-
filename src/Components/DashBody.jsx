...
const DashBody = (prop) => {
    ...
    const drawChart = (ctx) => {
        ...
        ctx.lineTo(points[points.length - 1].x, 10000 - padding); // Line down to the x-axis
        ctx.lineTo(points[0].x, 10000 - padding); // Line back to the starting point on the x-axis
        ctx.closePath();
