                                ...
                                <div className='lg:w-1/2 w-full'>
                                    ...
                                    <div className='dark:bg-blue-950 shadow mt-7 p-7 w-full rounded-xl'>
                                        ...
                                        <div className='flex flex-wrap'>
                                            ...
                                            <div className='flex md:w-1/2 w-full mt-7 gap-4'>
                                                <div className='p-[0.45rem] bg-green-300 rounded-xl inline-block'></div>
                                                <span>
                                        ...
                                        <div>
                                            <div className='w-1/2 rounded-xl bg-purple-500 p-4'>
                                                <div className='rounded-full w-24 flex h-24 m-auto relative z-50 bg-[rgba(243,232,255,0.27)]'>
                                                    <div className='rounded-tl-full z-10 relative rotate-[250deg] translate-x-[2rem] translate-y-[1.4rem] rounded-bl-full w-1/2 h-24 bg-white'></div>
