                            ...
                            <div className='w-full mt-5 flex flex-wrap lg:flex-nowrap gap-8'>
                                <div className='lg:w-1/2 w-full'>
                                    <div className='w-full flex flex-wrap md:flex-nowrap gap-8'>
                                        ...
                                        <div className='md:w-1/3 pt-5 rounded-xl w-full bg-[#d7edfd] h-[fit-content] text-center overflow-hidden'>
                                            <p className=''>Limit</p>
                                    ...
                                    <div className='bg-white dark:bg-blue-950 mt-12 shadow p-6 rounded-lg'>
                                        ...
                                        <div className='mt-10 snap-x flex gap-5 overflow-x-scroll whitespace-nowrap scroll-smooth scrooler gallery js-flickity' data-flickity-options='{ "wrapAround": true }'>
                                            {quickTransfer.map((qt, index) => (
                                                <div key={index} className='w-[fit-content] gallery-cell scroll-ml-14 snap-start bg-[#0099ff2a] py-3 px-1 rounded-xl'>
