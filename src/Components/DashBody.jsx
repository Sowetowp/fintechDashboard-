...
import { AreaPlot, BarChart, ChartContainer, LineChart, lineElementClasses } from '@mui/x-charts'
                                    ...
                                    <div className='dark:bg-blue-950 shadow mt-7 w-full rounded-xl'>
                                        <div className='flex justify-between flex-wrap items-center p-7'>
                                            <span>
                                                ...
                                                <p className='text-gray-500 text-sm gap-2 flex items-center'>
                                        ...
                                        <LineChart
                                            ...
                                            xAxis={[{ scaleType: 'point', data: ['Page A', 'Page B', 'Page C', 'Page D', 'Page E', 'Page F', 'Page G', 'Page H', 'Page I', 'Page C', 'Page D', 'Page E', 'Page F', 'Page G'], disableLine: true, disableTicks: true }]}
                                            sx={{
                                                [`& .${lineElementClasses.root}`]: {
                                                    display: 'none',
                                                },
