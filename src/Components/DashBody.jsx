                                ...
                                <div className='md:w-1/2 w-full'>
                                    ...
                                    <div className='bg-white dark:bg-blue-950 mt-12 shadow p-6 rounded-lg'>
                                        ...
                                        <div className='mt-2 flex items-center gap-3'>
                                            <button className='dark:text-white dark:border items-center px-4 py-2 rounded-xl bg-slate-100 flex gap-2 dark:bg-[rgba(45,53,81,0.37)] border-0 border-[rgb(71,80,109)]'>
