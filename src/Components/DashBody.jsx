                    ...
                    <div className='w-[22%] py-3'>
                        <a className='flex justify-around flex-wrap items-center group'>
                            ...
                            <div className='w-full py-2'>
                                <a className='block group-hover:text-[#0099FF]' text-center text-gray-500 py-[0.3rem] text-md' href="">Profile</a>
                                <a className='block group-hover:text-[#0099FF]' text-center text-gray-500 py-[0.3rem] text-md' href="">Email</a>
                                <a className='block group-hover:text-[#0099FF]' text-center text-gray-500 py-[0.3rem] text-md' href="">Calendar</a>
                                <a className='block group-hover:text-[#0099FF]' text-center text-gray-500 py-[0.3rem] text-md' href="">Shop</a>
                            </div>
                        </a>
                    </div>
                </section>
