                ...
                <section className='max-w-7xl w-full mx-auto flex'>
                    ...
                    <div className={`h-[200vh] ${prop.prop ? "md:w-[calc(100%-17rem)] w-full" : "w-full md:w-[calc(100%-5.5rem)]"} bg-gray-100 dark:bg-[rgb(17,26,56)] p-6`} style={{ transition: "width .5s ease" }}>
                        <div>
                            ...
                            <div className='w-full mt-5 flex flex-wrap md:flex-nowrap gap-6'>
                                <div className='md:w-1/2 w-full flex flex-wrap md:flex-nowrap gap-6'>
                                    ...
                                    <div className='md:w-1/3 w-full bg-[#d7edfd] text-center'>
                                        <p className=''>Limit</p>
                                        <p className='font-semibold text-2xl'>$4,000</p>
                                        <p>/$10,000</p>
                                    </div>
                                </div>
