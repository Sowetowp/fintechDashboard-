            ...
            <main className='w-full bg-white dark:bg-blue-950'>
                <section className='max-w-7xl w-full mx-auto'>
                    <div className='w-[22%] py-3'>
                        <div className={`h-[fit-content] bg-black ${isExpanded ? 'max-h-full' : 'max-h-0'}`} style={{transition: "height 1s ease", maxHeight: drop.dashboard ? '500px' : '0px'}}>
                            ...
                            <div className={`w-full py-2 ${drop.dashboard ? "block" : "hidden"}`}>
