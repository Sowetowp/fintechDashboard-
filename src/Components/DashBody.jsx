                                ...
                                <div className='lg:w-1/2 w-full'>
                                    ...
                                    <div className='dark:bg-blue-950 shadow mt-7 w-full rounded-xl'>
                                        ...
                                        <LineChart
                                            ...
                                            xAxis={[{ scaleType: 'point', data: ['Page A', 'Page B', 'Page C', 'Page D', 'Page E', 'Page F', 'Page G', 'Page A', 'Page B', 'Page C', 'Page D', 'Page E', 'Page F', 'Page G'], disableLine: true, disableTicks: true }]}
                                            sx={{
                                                [`& .${lineElementClasses.root}`]: {
                                                    display: 'none',
                                                },
