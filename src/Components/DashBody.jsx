                            ...
                            <div className='w-full mt-5 flex flex-wrap lg:flex-nowrap gap-8'>
                                <div className='lg:w-1/2 w-full'>
                                    ...
                                    <div className='bg-white dark:bg-blue-950 mt-12 shadow p-6 rounded-lg'>
                                        ...
                                        <div className='mt-10 flex gap-5 overflow-x-scroll w-[fit-content]'>
                                            {quickTransfer.map((qt, index) => (
                                                <div key={index} className='w-[fit-content] bg-[#0099ff2a] py-3 px-1 rounded-xl'>
                                                    <img src={qt.image} alt="" className='w-24 rounded-xl' />
                                                    <p className='dark:text-white text-lg text-center mt-3'>{qt.name}</p>
