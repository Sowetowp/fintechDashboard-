                            ...
                            <div className='w-full mt-5 flex flex-wrap lg:flex-nowrap gap-8'>
                                <div className='lg:w-1/2 w-full'>
                                    <div className='w-full flex flex-wrap lg:flex-nowrap gap-8'>
                                        ...
                                        <div className='lg:w-1/3 pt-5 rounded-xl w-full bg-[#d7edfd] h-[fit-content] text-center overflow-hidden'>
                                            <p className=''>Limit</p>
