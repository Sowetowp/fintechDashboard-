                    ...
                    <div className="w-2/3 sm:w-1/2 flex justify-between pl-5 items-center">
                        ...
                        <div className='relative'>
                            ...
                            <div className={`bg-white shadow min-w-80 mt-8 -ml-[17rem] rounded-md w-[max-content] absolute z-20 ${true ? "block" : "hidden"}`}>
                                ...
                                <a className='flex text-[#0099FF] text-md gap-4 py-3 justify-center hover:bg-gray-100 rounded-b-md'>See all notifications<img className='w-5' src={logout} alt="" /></a>
                            </div>
                        </div>
