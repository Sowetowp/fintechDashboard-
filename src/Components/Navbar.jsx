                ...
                <section className='px-5 max-w-7xl w-full mx-auto py-5 flex items-center'>
                    ...
                    <div className="w-2/3 sm:w-1/2 flex justify-between pl-5 items-center">
                        ...
                        <div className='relative inline-block'>
                            ...
                            <div className={`bg-white left-0 dark:bg-[rgb(17,26,56)] dark:text-gray-300 shadow mt-7 min-w-40 rounded-md w-[max-content] absolute z-20 py-3 ${profile ? "block" : "hidden"}`}>
