                ...
                <section className='px-5 max-w-7xl w-full mx-auto py-5 flex items-center'>
                    ...
                    <div className="w-2/3 sm:w-1/2 flex justify-between pl-5 items-center">
                        ...
                        <div className='relative'>
                            <a onClick={() => setNotification(!notification)} className="bg-white shadow rounded-[50%] h-[fit-content] p-2 flex items-center justify-center dark:bg-[rgb(17,26,56)]">
                            ...
                            <div className={`bg-white shadow min-w-80 mt-8 -ml-[17rem] rounded-md w-[max-content] absolute z-20 py-3 ${!profile ? "block" : "hidden"}`}>
                        ...
                        {profile || notification && <a onClick={() => {setProfile(!profile); setNotification(false)}} className='bg-[#80808041] cursor-pointer absolute w-screen h-screen top-0 left-0 right-0 z-10'></a>}
                        <div className='relative hidden sm:inline-block'>
                            ...
                            <div className={`bg-white shadow mt-7 m-2 min-w-40 rounded-md w-[max-content] absolute z-20 py-3 ${profile ? "block" : "hidden"}`}>
                                <a className='flex gap-4 px-5 py-2 hover:bg-gray-100'><img className='w-5' src={profileico} alt="" />Profile</a>
                                <a className='flex gap-4 px-5 py-2 hover:bg-gray-100'><img className='w-5' src={inbox} alt="" />Inbox</a>
                                <a className='flex gap-4 px-5 py-2 hover:bg-gray-100'><img className='w-5' src={logout} alt="" />Logout</a>
                            </div>
