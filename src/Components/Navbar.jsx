                        ...
                        <div className='relative'>
                            ...
                            <div className={`bg-white shadow mt-8 -ml-[17rem] rounded-md w-80 absolute z-20 ${true ? "block" : "hidden"}`}>
                                <a className='flex items-center p-3 border-b gap-3'>
                                    ...
                                    <span>
                                        <p style={{wordBreak:"break-word"}} className='font-semibold break-all text-md text-gray-700'>Dr sultrfffffffffffffffffffffffffffffffffffffffffffffffffffffads Senddddddddddd you Photo</p>
