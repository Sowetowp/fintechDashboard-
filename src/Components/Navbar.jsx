            ...
            <header className='w-full sticky top-0 bg-white dark:bg-blue-950 '>
                ...
                <section className={`fixed right-0 h-screen top-0 z-40`} style={{transform: chat ? "translateX(0%)" : "translateX(100%)", transition:"transform .7s ease"}}>
                    ...
                    <div className='flex items-center justify-around bg-white py-2 '>
                        <button className='flex items-center bg-gray-200 h-6 justify-center w-6 rounded-md'><img className='w-4' src={plus} alt="" /></button>
                        <span className='text-center'>
                            <p className='font-semibold text-sm'>Chat List</p>
                            <p className='text-xs text-gray-500'>Show All</p>
                        </span>
                        <button className='bg-gray-200 rounded-md py-2 px-1'><img className='w-4' src={menu} alt="" /></button>
                    </div>
                </section>
            </header>
        </>
