                ...
                <section className='max-w-7xl mx-auto py-5 flex items-center'>
                    ...
                    <div className="w-1/2 flex justify-around items-cente">
                        ...
                        <div className="bg-white relative shadow rounded-[50%] h-[fit-content] p-2 flex items-center justify-center dark:bg-[rgb(17,26,56)]">
                            ...
                            <sup className='absolute'><span className='px-[4px] ml-6 text-xs text-white bg-[#0099FF] shadow-[#0099FF] shadow rounded-full'>12</span></sup>
                        </div>
                        <div className="bg-white relative shadow rounded-[50%] h-[fit-content] p-2 flex items-center justify-center dark:bg-[rgb(17,26,56)]">
                            ...
                            <sup className='absolute'><span className='px-[4px] ml-6 text-xs text-white bg-[#0099FF] shadow-[#0099FF] shadow-none rounded-full'>5</span></sup>
                        </div>
