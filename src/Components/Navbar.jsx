                ...
                <section className='px-5 max-w-7xl w-full mx-auto py-5 flex items-center'>
                    ...
                    <div className="w-2/3 sm:w-1/2 flex justify-between pl-5 items-center">
                        ...
                        <div className='relative'>
                            ...
                            <div className={`bg-white shadow min-w-80 mt-8 -ml-[17rem] rounded-md w-[max-content] absolute z-20 py-3 ${notification ? "block" : "hidden"}`}>
                                ...
                                <a className='flex gap-4 px-5 py-2 hover:bg-gray-100'>See all notifications<img className='w-5' src={logout} alt="" /></a>
                            </div>
                        </div>
