    ...
    return (
        <>
            <header className='w-full sticky top-0 bg-white dark:bg-blue-950 '>
                ...
                <section className={`fixed right-0 h-screen top-0 bg-red-500 z-40`} style={{transform: chat ? "translateX(0%)" : "translateX(100%)", transition:"transform .7s ease"}}>
                    ...
                    <div>
                        ...
                        <button className='text-black bg-gray-200'><img src={menu} alt="" /></button>
                    </div>
                </section>
            </header>
        </>
