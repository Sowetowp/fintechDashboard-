                ...
                <section className='px-5 max-w-7xl w-full mx-auto py-5 flex items-center'>
                    ...
                    <div className="w-2/3 sm:w-1/2 flex justify-between pl-5 items-center">
                        ...
                        <div className=''>
                            ...
                            <div className={`bg-white py-1 dark:bg-[rgb(17,26,56)] shadow mt-8 md:left-auto md:-ml-[17rem] left-0 rounded-md md:w-80 w-screen absolute z-20 ${notification ? "block" : "hidden"}`} onBlur={() => setNotification(false)}>
