    ...
    return (
        <>
            <header className='w-full sticky top-0 bg-white dark:bg-blue-950 '>
                ...
                <section className={`fixed righet-0 m-auto h-screen top-0 z-40 w-[90%] md:w-[22rem]`} style={{ transform: chat ? "translateX(0%)" : "translateX(100%)", transition: "transform .7s ease" }}>
