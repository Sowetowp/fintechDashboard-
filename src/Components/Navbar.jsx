            ...
            <header className='w-full sticky top-0 bg-white dark:bg-blue-950 '>
                ...
                <section className='absolute right-0 h-screen top-0 bg-red-500 z-40'>
                    <div className='flex justify-around w-full md:w-[22rem] bg-[#0099FF] pt-5 '>
                        <a href="" className='text-white text-base font-semibold border-b-4 pb-3'>HOME</a>
                        <a href="" className='text-white text-base font-semibold border-b-4 pb-3'>ALERTS</a>
                        <a href="" className='text-white text-base font-semibold border-b-4 pb-3'>CHAT</a>
                    </div>
                </section>
            </header>
        </>
