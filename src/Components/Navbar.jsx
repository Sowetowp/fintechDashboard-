...
const Navbar = () => {
    ...
    return (
        <>
            <header style={{overflow:"hidden"}} className='sticky top-0 dark:bg-blue-950 '>
                <section style={{overflow:"hidden"}} className='max-w-7xl w-full bg-slate-500 mx-auto py-5 flex items-center'>
