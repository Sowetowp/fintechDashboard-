    ...
    return (
        <>
            <header className='w-full sticky top-0 bg-white dark:bg-blue-950 '>
                ...
                {(profile || notification || chat) && <a onClick={() => { setProfile(false); setNotification(false) }} className='bg-[#80808024] absolute w-full h-screen top-0 left-0 right-0 z-10'></a>}
                {chat && <section className='absolute right-0 h-screen top-0 bg-red-500 z-40'>
