        ...
        <>
            <header className='w-full sticky top-0 bg-white dark:bg-blue-950 '>
                <section className='px-5 max-w-7xl w-full mx-auto py-5 flex items-center'>
                    <div className={`w-1/3 sm:w-1/2 flex items-center ${prop ? "justify-between" : "gap-5 justify-start"}`}                     <div className={`w-1/3 sm:w-1/2 flex items-center ${prop ? "justify-between" : "gap-5"}`} style={{transition: "justify-content 0.3s ease"}}>
                    >
