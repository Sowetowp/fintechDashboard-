                ...
                <section className='px-5 max-w-7xl w-full mx-auto py-5 flex items-center'>
                    ...
                    <div className="w-2/3 sm:w-1/2 flex justify-between pl-5 items-center">
                        ...
                        <div className='relative'>
                            ...
                            <div className={`bg-white dark:bg-[rgb(17,26,56)] dark:border-gray-600 shadow mt-8 -right-32 md:-right-4 rounded-md md:w-80 w-screen absolute z-20 ${notification ? "block" : "hidden"}`}>
                        ...
                        {profile || notification && <a onClick={() => { setProfile(false); setNotification(false) }} className='bg-[#80808041] absolute w-screen h-screen top-0 left-0 right-0 z-10'></a>}
                        <div className='relative hidden sm:inline-block'>
                            ...
                            <div className={`bg-white dark:bg-[rgb(17,26,56)] shadow mt-7 m-2 min-w-40 rounded-md w-[max-content] absolute z-20 py-3 ${profile ? "block" : "hidden"}`}>
